...
namespace Application.CommandHandlers
{
    public class CreateDynamicEndpointCommandHandler : IRequestHandler<CreateDynamicEndpointCommand, bool>
    {
        ...
        {
            var languageCharp = _languageRepository.GetById(LanguageDomain.LANGUAGE_CSHARP);

            var entitiesTemplates =
                request.Entities.Select(entity => new EntityTemplate(entity, languageCharp)).ToList();
